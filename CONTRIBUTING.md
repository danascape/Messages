...
To update the wiki, simply navigate to the [wiki tab](https://github.com/PVOT-OSS/Messages/wiki) in this repository, find the file that you need to edit, and then click `Edit Page`. Then you can edit and commit your change. For more sizeable changes, and for feedback and questions please comment in [this discussion](https://github.com/PVOT-OSS/Messages/discussions/174).
